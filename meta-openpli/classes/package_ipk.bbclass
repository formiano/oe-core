...
package_tryout_install_multilib_ipk() {
	...
	for item in ${MULTILIB_VARIANTS}; do
		...
		local ipkg_args="-f ${INSTALL_CONF_IPK} -o ${target_rootfs} --force-overwrite --force-maintainer"
		local selected_pkg=""
...
package_install_internal_ipk() {
	...
	local ipkg_args="-f ${conffile} -o ${target_rootfs} --force-overwrite --force-maintainer --force_postinstall"
